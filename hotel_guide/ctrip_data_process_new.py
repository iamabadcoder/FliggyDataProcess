...
def get_zone_list_by_lcs(ctrip_zone_name, fliggy_zone_list):
	selected_zones = {}
	for fliggy_zone in fliggy_zone_list:
		lcs_str, lcs_len = find_lcsubstr(ctrip_zone_name, fliggy_zone)
		if lcs_len > 0:
			selected_zones[fliggy_zone] = lcs_len
	return sorted(selected_zones.iteritems(), key=lambda asd: asd[1], reverse=True)
...
if __name__ == '__main__':
	...
	ctrip_setp2_file_name = 'ctrip_hotel_guide_data_step2.txt'  # 待人工处理
